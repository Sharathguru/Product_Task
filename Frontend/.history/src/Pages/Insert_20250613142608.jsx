...
<form action="">
    ...
    <div>
        ...
        <input type="text" name="Series_No" value={data.Series_No} onChange={handleChange} />
    </div>
    <div>
        <label>Product Purchase Date:</label>
        <input type="date" name="Product_Purchase_Date" value={data.Product_Purchase_Date} onChange={handleChange} />
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="Product_Dealership" value={data.Product_Dealership} onChange={handleChange} />
    </div>
